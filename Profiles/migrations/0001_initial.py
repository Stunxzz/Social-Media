# Generated by Django 4.2.13 on 2024-05-16 13:21
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profile_picture', models.ImageField(default='static/img/profile_pics/blank-profile.webp', upload_to='profile_pictures/')),
                ('other_images', models.ManyToManyField(blank=True, to='Profiles.images')),
